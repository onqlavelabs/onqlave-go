...
const (
	...
	FETCHING_ENCRYPTION_KEY_RESPONSE_UNMARSHALING_FAILED string = "[onqlave] SDK: %s - Failed unmarshalling encryption key response"
	...
	FETCHING_DECRYPTION_KEY_RESPONSE_UNMARSHALING_FAILED string = "[onqlave] SDK: %s - Failed unmarshalling decryption key response"
	...
	KEY_UNWRAPPING_KEY_FAILED        string = "[onqlave] SDK: %s - Failed unwrapping encryption key"
	...
	ENCRYPTION_OPERATION_FAILED string = "[onqlave] SDK: %s - Failed encrypting plain data"
	...
	DECRYPTION_OPERATION_FAILED string = "[onqlave] SDK: %s - Failed decrypting cipher data"
